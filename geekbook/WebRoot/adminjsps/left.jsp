...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/adminjsps/css/book/left.css'/>">
 ...
 * 1. 对象名必须与第一个参数相同！
   2. 第二个参数是显示在菜单上的大标题
 */
var bar = new Q6MenuBar("bar", "极客书城");
$(function() {
...
<c:forEach items="${parents}" var="parent">
  <c:forEach items="${parent.children}" var="child">
	bar.add("${parent.cname}", "${child.cname}", "/geekbook/admin/AdminBookServlet?method=findByCategory&cid=${child.cid}", "body");
  </c:forEach>
</c:forEach>
