$(function() {
	...
	$("#submit").hover(
		function() {
			$("#submit").attr("src", "/geekbook/images/login2.jpg");
		},
		function() {
			$("#submit").attr("src", "/geekbook/images/login1.jpg");
		}
	);
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#vCode").attr("src", "/geekbook/VerifyCodeServlet?a=" + new Date().getTime());
}
