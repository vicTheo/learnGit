package cn.geekbook.user.service;
...
import cn.geekbook.mail.Mail;
import cn.geekbook.mail.MailUtils;
import cn.geekbook.user.dao.UserDao;
import cn.geekbook.user.domain.User;
import cn.geekbook.user.service.exception.UserException;
import cn.geekbook.utils.Md5Utils;
...
public class UserService {
	...
	public void updatePassword(String uid, String newPass, String oldPass) throws UserException {
		...
		try {
			...
			oldPass=md.convertMd5(md.string2md5(oldPass));
			 ...
			 * 2. 修改密码
			 */
			newPass=md.convertMd5(md.string2md5(newPass));
	...
	public User login(User user) {
		try {
			Md5Utils md=new Md5Utils();
			user.setLoginpass(md.convertMd5(md.string2md5(user.getLoginpass())));
